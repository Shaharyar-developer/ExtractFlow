...
var _a, _b, _c, _d, _e, _f, _validator, _encryptionKey, _options, _defaultValues;
...
var F = (n, r, e) => (S(n, r, "read from private field"), e ? e.call(n) : r.get(n)), y = (n, r, e) => {
  if (r.has(n))
    throw TypeError("Cannot add the same private member more than once");
  r instanceof WeakSet ? r.add(n) : r.set(n, e);
}, L = (n, r, e, i) => (S(n, r, "write to private field"), r.set(n, e), e);
...
var H, z$1, x, B, V, J;
typeof window > "u" || "Deno" in window || ((z$1 = (H = globalThis.process) == null ? void 0 : H.env) == null ? void 0 : z$1.NODE_ENV) === "test" || (B = (x = globalThis.process) == null ? void 0 : x.env) != null && B.JEST_WORKER_ID || (J = (V = globalThis.process) == null ? void 0 : V.env) != null && J.VITEST_WORKER_ID;
function ie(n) {
...
function de() {
  ...
  P = function(t2, o) {
    o = o || {};
    var s = typeof t2;
    if (s === "string" && t2.length > 0)
      return p(t2);
    if (s === "number" && isFinite(t2))
      return o.long ? c(t2) : g(t2);
    throw new Error(
      "val is not a non-empty string or a valid number. val=" + JSON.stringify(t2)
    );
  };
  function p(t2) {
    if (t2 = String(t2), !(t2.length > 100)) {
  ...
  function g(t2) {
    var o = Math.abs(t2);
    return o >= i ? Math.round(t2 / i) + "d" : o >= e ? Math.round(t2 / e) + "h" : o >= r ? Math.round(t2 / r) + "m" : o >= n ? Math.round(t2 / n) + "s" : t2 + "ms";
  }
  function c(t2) {
    var o = Math.abs(t2);
    return o >= i ? u(t2, o, i, "day") : o >= e ? u(t2, o, e, "hour") : o >= r ? u(t2, o, r, "minute") : o >= n ? u(t2, o, n, "second") : t2 + " ms";
  }
  function u(t2, o, s, d) {
    var h = o >= s * 1.5;
    return Math.round(t2 / s) + " " + d + (h ? "s" : "");
  }
  return P;
}
function le(n) {
  e.debug = e, e.default = e, e.coerce = c, e.disable = C, e.enable = a, e.enabled = p, e.humanize = de(), e.destroy = u, Object.keys(n).forEach((t2) => {
    e[t2] = n[t2];
  }), e.names = [], e.skips = [], e.formatters = {};
  function r(t2) {
    let o = 0;
    for (let s = 0; s < t2.length; s++)
      o = (o << 5) - o + t2.charCodeAt(s), o |= 0;
  ...
  function e(t2) {
    ...
    return l.namespace = t2, l.useColors = e.useColors(), l.color = e.selectColor(t2), l.extend = i, l.destroy = e.destroy, Object.defineProperty(l, "enabled", {
      enumerable: true,
      configurable: false,
      get: () => s !== null ? s : (d !== e.namespaces && (d = e.namespaces, h = e.enabled(t2)), h),
      set: (f) => {
        s = f;
      }
  ...
  function i(t2, o) {
    const s = e(this.namespace + (typeof o > "u" ? ":" : o) + t2);
    return s.log = this.log, s;
  }
  function a(t2) {
    e.save(t2), e.namespaces = t2, e.names = [], e.skips = [];
    let o;
    const s = (typeof t2 == "string" ? t2 : "").split(/[\s,]+/), d = s.length;
    for (o = 0; o < d; o++)
      s[o] && (t2 = s[o].replace(/\*/g, ".*?"), t2[0] === "-" ? e.skips.push(new RegExp("^" + t2.slice(1) + "$")) : e.names.push(new RegExp("^" + t2 + "$")));
  }
  function C() {
    const t2 = [
      ...e.names.map(g),
  ...
  function p(t2) {
    ...
    for (o = 0, s = e.skips.length; o < s; o++)
      if (e.skips[o].test(t2))
        return false;
    for (o = 0, s = e.names.length; o < s; o++)
      if (e.names[o].test(t2))
        return true;
    return false;
  }
  function g(t2) {
    return t2.toString().substring(2, t2.toString().length - 2).replace(/\.\*\?$/, "*");
  }
  function c(t2) {
...
async function ge({
  ...
  const { type: p, input: g, path: c, id: u } = i.operation, t2 = g ? n._def._config.transformer.input.deserialize(g) : void 0, o = await (r == null ? void 0 : r({ event: a })) ?? {}, s = (d) => {
...
const m = Q("electron-trpc:main:IPCHandler"), he = (n, r) => {
...
class be {
  constructor({
    ...
    i.forEach((a) => this.attachWindow(a)), ipcMain.on(T, (a, C) => {
      ge({
        router: e,
        createContext: r,
        internalId: he(a, C),
  ...
  attachWindow(r) {
    F(this, w).includes(r) || (m("Attaching window", r.id), F(this, w).push(r), v(this, N, Z).call(this, r));
  }
  detachWindow(r, e) {
    if (m("Detaching window", r.id), r.isDestroyed() && e === void 0)
      throw new Error("webContentsId is required when calling detachWindow on a destroyed window");
    L(this, w, F(this, w).filter((i) => i !== r)), v(this, R, M).call(this, { webContentsId: e ?? r.webContents.id });
  }
}
...
const ye = ({
  ...
  router: r,
  windows: e = []
}) => new be({ createContext: n, router: r, windows: e });
var util$2;
(function(util2) {
...
class ZodNativeEnum extends ZodType {
  ...
  _parse(input) {
    ...
    if (!__classPrivateFieldGet(this, _ZodNativeEnum_cache)) {
      __classPrivateFieldSet(this, _ZodNativeEnum_cache, new Set(util$2.getValidEnumValues(this._def.values)));
    }
...
function getStatusCodeFromKey(code2) {
  return JSONRPC2_TO_HTTP_CODE[code2] ?? 500;
}
...
function createRouterFactory(config) {
  return function createRouterInner(procedures) {
    ...
    const router2 = {
      ...
      getErrorShape(opts) {
        const { path: path2, error: error2 } = opts;
        const { code: code2 } = opts.error;
        const shape = {
          message: error2.message,
          code: TRPC_ERROR_CODES_BY_KEY[code2],
          data: {
            code: code2,
...
function callProcedure(opts) {
  var _a2;
  const { type: type2, path: path2 } = opts;
  if (!(path2 in opts.procedures) || !((_a2 = opts.procedures[path2]) == null ? void 0 : _a2._def[type2])) {
    throw new TRPCError({
      code: "NOT_FOUND",
      message: `No "${type2}"-procedure on path "${path2}"`
    });
  }
  ...
  return function createCallerInner(router2) {
    ...
    return function createCaller(ctx) {
      const proxy = createRecursiveProxy(({ path: path2, args }) => {
        ...
        const procedure = def2.procedures[fullPath];
        let type2 = "query";
...
const isPrimitive = (payload) => isBoolean(payload) || isNull(payload) || isUndefined$1(payload) || isNumber(payload) || isString$1(payload) || isSymbol(payload);
...
const typedArrayRule = compositeTransformation(isTypedArray, (v2) => ["typed-array", v2.constructor.name], (v2) => [...v2], (v2, a) => {
...
const untransformValue = (json, type2, superJson) => {
  if (isArray$1(type2)) {
    switch (type2[0]) {
      case "symbol":
...
const getDeep = (object, path2) => {
  ...
  for (let i = 0; i < path2.length; i++) {
    ...
    if (isSet(object)) {
      ...
      const row = +key;
      const type2 = +path2[++i] === 0 ? "key" : "value";
...
function traverse$4(tree, walker2, origin = []) {
  if (!tree) {
    return;
  }
  if (!isArray$1(tree)) {
    forEach(tree, (subtree, key) => traverse$4(subtree, walker2, [...origin, ...parsePath(key)]));
    return;
  }
  const [nodeValue, children] = tree;
  if (children) {
    forEach(children, (child, key) => {
      traverse$4(child, walker2, [...origin, ...parsePath(key)]);
    });
  }
  walker2(nodeValue, origin);
}
function applyValueAnnotations(plain, annotations, superJson) {
  traverse$4(annotations, (type2, path2) => {
    plain = setDeep(plain, path2, (v2) => untransformValue(v2, type2, superJson));
  });
  return plain;
}
...
function makeMergeEvaluated$1({ mergeNames, mergeToName, mergeValues: mergeValues2, resultToName }) {
  return (gen, from, to, toName) => {
    const res = to === void 0 ? from : to instanceof codegen_1$13.Name ? (from instanceof codegen_1$13.Name ? mergeNames(gen, from, to) : mergeToName(gen, from, to), to) : from instanceof codegen_1$13.Name ? (mergeToName(gen, to, from), from) : mergeValues2(from, to);
...
function isJSONType$1(x2) {
  return typeof x2 == "string" && jsonTypes$1.has(x2);
}
...
const hexLookUp = Array.from({ length: 127 }, (v2, k) => /[^!"$&'()*+,\-.;=_`a-z{}~]/u.test(String.fromCharCode(k)));
...
(function(exports) {
  ...
  function requiredOptions(o) {
    var _a2, _b2, _c2, _d2, _e2, _f2, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0;
    const s = o.strict;
...
function callRef$1(cxt, v2, sch, $async) {
  ...
  function callAsyncRef() {
    ...
    const valid2 = gen.let("valid");
    gen.try(() => {
      gen.code((0, codegen_1$V._)`await ${(0, code_1$j.callValidateCode)(cxt, v2, passCxt)}`);
      addEvaluatedFrom(v2);
      if (!allErrors)
        gen.assign(valid2, true);
    }, (e) => {
...
const error$w = {
  message: ({ params: { i, j: j2 } }) => (0, codegen_1$N.str)`must NOT have duplicate items (items ## ${j2} and ${i} are identical)`,
  params: ({ params: { i, j: j2 } }) => (0, codegen_1$N._)`{i: ${i}, j: ${j2}}`
};
const def$V = {
  keyword: "uniqueItems",
  type: "array",
  ...
  code(cxt) {
    ...
    function validateUniqueItems() {
      ...
      gen.assign(valid2, true);
      gen.if((0, codegen_1$N._)`${i} > 1`, () => (canOptimize() ? loopN : loopN2)(i, j2));
    }
    ...
    function loopN(i, j2) {
      ...
      gen.for((0, codegen_1$N._)`;${i}--;`, () => {
        ...
        gen.if((0, codegen_1$N._)`typeof ${indices}[${item}] == "number"`, () => {
          gen.assign(j2, (0, codegen_1$N._)`${indices}[${item}]`);
          cxt.error();
    ...
    function loopN2(i, j2) {
      ...
      gen.label(outer).for((0, codegen_1$N._)`;${i}--;`, () => gen.for((0, codegen_1$N._)`${j2} = ${i}; ${j2}--;`, () => gen.if((0, codegen_1$N._)`${eql}(${data}[${i}], ${data}[${j2}])`, () => {
        cxt.error();
...
const def$T = {
  ...
  code(cxt) {
    ...
    function loopEnum() {
      gen.assign(valid2, false);
      gen.forOf("v", schemaCode, (v2) => gen.if((0, codegen_1$L._)`${getEql()}(${data}, ${v2})`, () => gen.assign(valid2, true).break()));
    }
...
function dynamicAnchor(cxt, anchor) {
  ...
  const v2 = (0, codegen_1$B._)`${names_1$9.default.dynamicAnchors}${(0, codegen_1$B.getProperty)(anchor)}`;
  const validate2 = it.errSchemaPath === "#" ? it.validateName : _getValidate(cxt);
  gen.if((0, codegen_1$B._)`!${v2}`, () => gen.assign(v2, validate2));
}
...
function dynamicRef(cxt, ref2) {
  ...
  function _dynamicRef(valid2) {
    if (it.schemaEnv.root.dynamicAnchors[anchor]) {
      const v2 = gen.let("_v", (0, codegen_1$A._)`${names_1$8.default.dynamicAnchors}${(0, codegen_1$A.getProperty)(anchor)}`);
...
const router = t.router({
  ...
  getOllamaUrl: t.procedure.query(() => {
    return store.get("ollamaUrl") || "https://ollama.com";
  }),
  getKeyPoints: t.procedure.query(() => {
    return store.get("keyPoints") || [];
  }),
  setKeyPoints: t.procedure.input(
    z.object({
      title: z.string(),
    ...
    const { input } = req;
    const keyPoints = store.get("keyPoints") || [];
